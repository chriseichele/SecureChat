...
public class Message {
	 ...
	 */
	public Message(String message, String signature, boolean isMine, String sender_id, String reciever_id, Date datetime) {
	...
	public Message(String message, String signature, boolean isMine, String sender_id, String reciever_id) {
		this(message, signature, isMine, sender_id, reciever_id, Calendar.getInstance().getTime());
	}
